            ...
            <Card>
              <ListGroup.Item>
                <Row className="justify-content-md-center">
                  <span>
                    {" "}
                    <h4 style={{ color }}> Your Product </h4>
                  </span>
                </Row>{" "}
              </ListGroup.Item>{" "}
              <ListGroup.Item>
              ...
              <ListGroup.Item>
                <Row>
                  <Col> Manufacture </Col> <Col> Value </Col>{" "}
                </Row>{" "}
                {/* <Row>
                                        <Col>Test:</Col>
                                        <Col>Value</Col>
              ...
              <ListGroup.Item>
                <Row>
                  <Col> Suppliare </Col> <Col> Value </Col>{" "}
                </Row>{" "}
                {/* <Row>
                                        <Col>Test:</Col>
                                        <Col>Value</Col>
              ...
              <ListGroup.Item>
                <Row>
                  <Col> Place of Home </Col> <Col> Value </Col>{" "}
                </Row>{" "}
                {/* <Row>
                                        <Col>Test:</Col>
                                        <Col>Value</Col>
              ...
              <ListGroup.Item>
                <Row>
                  <Col> Delivary Time </Col> <Col> Value </Col>{" "}
                </Row>{" "}
                {/* <Row>
                                        <Col>Test:</Col>
                                        <Col>Value</Col>
